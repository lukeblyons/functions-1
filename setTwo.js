...
// OR
// function multiply(num1, num2, callback) => callback(num1 * num2)
...
// OR
// const last(names, callback) => callback(names[names.length - 1])
...
// CODE HERE
let addNumber = addingFactory(100)
console.log(addNumber(99))
